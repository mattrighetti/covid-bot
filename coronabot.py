...
regions_keyboard = [[InlineKeyboardButton("Dati Italia", callback_data='rItaly')],
                    ...
                    [InlineKeyboardButton("P.A. Trento", callback_data='rP.A. Trento'), InlineKeyboardButton("Umbria", callback_data='rUmbria')],
                    [InlineKeyboardButton("Valle d'Aosta", callback_data='rValle d\'Aosta'), InlineKeyboardButton("P.A. Bolzano", callback_data='rP.A. Bolzano')],
                    [InlineKeyboardButton("Veneto", callback_data='rVeneto')]]
